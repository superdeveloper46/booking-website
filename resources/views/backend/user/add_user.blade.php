                ...
                <div class="col-lg-12">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body p-4">
                            ...
                            <form  class="row g-3" action="{{ route('store.user') }}" method="post" enctype="multipart/form-data">
                                @csrf
                                ...
                                <div class="col-md-6">
                                    <label for="input1" class="form-label">User Phone </label>
                                    <input type="text" name="phone" class="form-control"   >

                                </div>
                                <div class="col-md-6">
                                    <label for="input1" class="form-label">User Address </label>
